...
%             temp_data = zeros(e,80);
%             temp_data(:,1:6) = joint_positions(:,1:6);
%             temp_data(:,7:48) = human_sphere(:,1:42);
%             temp_data(:,49) = file_n;
%             temp_data(:,50:79) = from_high(:,1:30);
%             temp_data(:,80)=max_diff;
%             T = array2table(temp_data);
%             new_filename = sprintf('new_data_%i.csv',iter_temp);
