...
if("TRUE" STREQUAL "TRUE")
  set(ur_gazebo_SOURCE_PREFIX /home/robot/workspaces/ur5_mpc_ursim/src/universal_robot/ur_gazebo)
  set(ur_gazebo_DEVEL_PREFIX /home/robot/workspaces/ur5_mpc_ursim/devel)
  ...
  set(ur_gazebo_INSTALL_PREFIX /home/robot/workspaces/ur5_mpc_ursim/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/workspaces/ur5_mpc_ursim/src/universal_robot/ur_gazebo/${idir}'.  ${_report}")
    endif()
