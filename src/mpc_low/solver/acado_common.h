...
/** Column vector of size: 8426 */
real_t conAuxVar[ 8426 ];

/** Row vector of size: 73 */
real_t conValueIn[ 73 ];

/** Row vector of size: 1560 */
real_t conValueOut[ 1560 ];

/** Column vector of size: 1040 */
real_t evH[ 1040 ];

/** Matrix of size: 1040 x 7 (row major format) */
real_t evHx[ 7280 ];
...
/** Column vector of size: 1040 */
real_t pacA01Dx0[ 1040 ];

/** Matrix of size: 70 x 70 (row major format) */
real_t H[ 4900 ];

/** Matrix of size: 1040 x 70 (row major format) */
real_t A[ 72800 ];
