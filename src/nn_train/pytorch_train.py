...
def visualize(predicted_data, real_data, logfile, x_test,loss1,loss2):
    ...
    fig2.show()
    fig2.savefig("loss_{}.png".format(run_name))
    plt.close()
...
if __name__ == '__main__':
    ...
    # model.load_state_dict(torch.load('model_20210929_141708.pth'))
    predicted_data, real_data = test(model, x_test, y_test)
    visualize(predicted_data, real_data, test_log, x_test,train_losses,eval_losses)
