...
echo_and_run cd "/home/robot/workspaces/ur5_mpc_ursim/src/universal_robot/ur_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/robot/workspaces/ur5_mpc_ursim/src/universal_robot/ur_driver/setup.py" \
     \
    build --build-base "/home/robot/workspaces/ur5_mpc_ursim/build/universal_robot/ur_driver" \
    install \
    --root="${DESTDIR-/}" \
